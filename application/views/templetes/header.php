...
<header id="header">
			    ...
			    <div class="container main-menu">
			    	...
			    	<h1 > <strong><i> <a href="<?= base_url()?>welcome" style="color:yellow;">Transco-plus</a></i></strong>	</h1><small style="margin-right: 250px;text-size:20px;"> <h3 style="color:greenyellow;"> Inscription </h3></small>	
						<nav id="nav-menu-container">
							<ul class="nav-menu">
							  <li class="menu-active"><a href="<?= base_url()?>welcome">Page d'accueil</a></li>
